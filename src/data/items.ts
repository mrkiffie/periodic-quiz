...
// data sourced from https://raw.githubusercontent.com/Bowserinator/Periodic-Table-JSON/master/PeriodicTableJSON.json
...
export const indexedElements: { [k: string]: IElement } = elements.reduce(
  (hash, element) => {
    hash[element.symbol] = element;
    return hash;
  },
  {}
);
