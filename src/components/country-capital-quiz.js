...
class CountryCapitalQuiz extends Component {
  ...
  render() {
    ...
    return (
      <div className="country-capital-quiz">
...
export default connect(state => ({...state.quiz}), {selectCountry, loadQuiz})(CountryCapitalQuiz);
