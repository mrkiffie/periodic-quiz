...
class FlagListIndexBase extends React.Component<IFlagListIndex> implements IVirtulizedList {
  rowRenderer = ({ key, index, style }) => {
    ...
    return (
      <ListItem containerElement={<Link to={`/countries/${country.iso}`} />} key={key} style={style}>
